...
q=.99               %discount rate for older memory
...
monitorCrosscorr=1; %if this option=1, the crosscorrelation btw. envir. and behav.
...
pfix(2,1:50)=5.5/10;
% pfix(1,51:100)=5.5/10;
pfix(2,51:120)=4.5/10;
