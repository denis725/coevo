...
aversion=-1/10        %positive (+) or negative (-) information is taken into account more
                    %strongly, with factor abs(aversion); 0,-1,+1->unbiased
tallyn=50           %tally number, the number of "screened" individuals
