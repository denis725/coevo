...
%     end
    ...
    for ii=1:n(i,itally,t)
        scvec=scvec+(n(:,istrat,t)==10).*(...
            1*((n(randtmat(:,ii),ichoice,t)==1)&(n(randtmat(:,ii),isucc,t)==1))-... %choice A + suc
            1*((n(randtmat(:,ii),ichoice,t)==0)&(n(randtmat(:,ii),isucc,t)==1))-... %choice B + suc
...
%     % alternatively: tie->random choice
%     randchoice=-.5+rand(nindi,1)>1/2;
%     scvec(find(scvec==0))=randchoice(find(scvec==0));
