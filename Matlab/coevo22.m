...
n(:,ipind,:)=repmat(ninitial(:,ipind),1,tmax);      % probs stay same
n(:,ipmaj,:)=repmat(ninitial(:,ipmaj),1,tmax);      % probs stay same
n(:,ipsuc,:)=repmat(ninitial(:,ipsuc),1,tmax);      % probs stay same
n(:,ipwea,:)=repmat(ninitial(:,ipwea),1,tmax);      % probs stay same
n(:,iphi1,:)=repmat(ninitial(:,iphi1),1,tmax);      % probs stay same
n(:,iphi2,:)=repmat(ninitial(:,iphi2),1,tmax);      % probs stay same
n(:,iprei,:)=repmat(ninitial(:,iprei),1,tmax);      % probs stay same
...
for t=1:tmax
    ...
    % update bias towards A or B for individual learning
